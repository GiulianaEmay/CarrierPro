...
// Trujillo embed (no API key required)
const MAP_EMBED =
    ...
    >
      <div className="container-cp">
        ...
        <div className="mt-12 grid lg:grid-cols-[1.4fr_1fr] gap-6">
          <div
            className="relative h-[360px] sm:h-[480px] rounded-3xl border border-white/10 overflow-hidden bg-black"
          ...
          >
            <iframe
              ...
              src={MAP_EMBED}
              loading="lazy"
              className="absolute inset-0 h-full w-full grayscale-[0.4] contrast-110 brightness-[0.7]"
          ...
          <div className="space-y-3">
            {active ? <ActiveCard s={active} /> : null}
                ...
                <div className="p-5">
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#f5961d] hover:text-white transition-colors"
                      data-testid={`station-cta-${s.id}`}
                    >
...
function ActiveCard({ s }) {
  return (
    <div
      ...
      data-testid="active-station-card"
    >
      <div className="flex items-start justify-between gap-3">
        <div>
          <div className="text-[11px] font-mono uppercase tracking-[0.18em] text-[#f5961d]">
            Seleccionada
          </div>
      ...
      <div className="mt-4 space-y-2.5 text-sm text-white/75">
        <div className="flex items-start gap-2.5">
          <MapPin size={14} className="text-[#f5961d] mt-0.5 shrink-0" /> {s.direccion}
        </div>
        <div className="flex items-center gap-2.5">
          <Clock size={14} className="text-[#f5961d]" /> {s.horario}
        </div>
        <div className="flex items-center gap-2.5">
          <Phone size={14} className="text-[#f5961d]" /> {s.telefono}
        </div>
      </div>
      ...
      <a
        ...
        data-testid="active-station-directions"
      >
        Cómo llegar
        <ExternalLink size={16} />
      </a>
